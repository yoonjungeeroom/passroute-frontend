    ...
    <div className="min-h-screen w-full bg-slate-50 text-slate-900">
      ...
      <main className="mx-auto w-full max-w-[1040px] px-6 py-9">
        ...
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-[22px] font-extrabold tracking-tight text-slate-900">토론 면접 리포트</h1>
        ...
        {status === "timeout" && (
          <div className="flex flex-col items-center justify-center gap-4 py-24">
            ...
            <div className="flex gap-3">
              ...
              <Button variant="ghost" onClick={() => router.push("/reports?type=debate")}>목록으로</Button>
            </div>
          </div>
        )}
